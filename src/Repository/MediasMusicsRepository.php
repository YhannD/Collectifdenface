...
/**
 * @extends ServiceEntityRepository<MediasMusics>
 *
...
class MediasMusicsRepository extends ServiceEntityRepository
{
    ...
    public function add(MediasMusics $entity, bool $flush = false): void
    {
    ...
    public function remove(MediasMusics $entity, bool $flush = false): void
    {
